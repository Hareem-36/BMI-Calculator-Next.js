...
export default function BmiCalculator() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-sky-200 dark:bg-gray-900">
      {/* Center the BMI calculator card within the screen */}
      <Card className="w-full max-w-md mx-auto">
        <CardHeader>
          {/* Header with title and description */}
          <center><u><CardTitle>BMI Calculator</CardTitle></u></center>
          <CardDescription className="text-base text-gray-600 font-bold mt-2">
  Enter your height and weight to calculate your BMI.
</CardDescription>

        </CardHeader>
        <CardContent className="space-y-4 font-bold  text-blue-700">
          {/* Input for height */}
          <div className="font-bold grid gap-2">
            <b><Label htmlFor="height">Height (cm)</Label></b>
            <Input
              id="height"
              type="number"
          ...
          <div className="grid gap-2">
           <b> <Label htmlFor="weight">Weight (kg)</Label></b>
            <Input
              id="weight"
              type="number"
         ...
         <center><Button onClick={calculateBmi}>Calculate</Button></center> 
      ...
      <br></br><div className="flex flex-col items-center justify-center  bg-gray-100">
